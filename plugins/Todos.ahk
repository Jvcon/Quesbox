...
; Define the GUI.
    Gui, todoGui: New
    Gui, todoGui: +Resize
    Gui, todoGui: Add, Text,, %ADD_LABEL%
    Gui, todoGui: Add, Text,, %CONTEXT_LABEL%
    Gui, todoGui: Add, Text,, %PROJECT_LABEL%
    Gui, todoGui: Add, Text,, %ITEMS_LABEL%
    Gui, todoGui: Add, Edit, vNewItem ym w400
    Gui, todoGui: Add, ComboBox, vContext gContext w400 Sort, %ALL_TEXT%||%NONE_TEXT%
    Gui, todoGui: Add, ComboBox, vProject gProject w400 Sort, %ALL_TEXT%||%NONE_TEXT%
    Gui, todoGui: Add, ListView, vItems gItems Checked w400, %CHECK_HEADER%|%TEXT_HEADER%|%CONTEXT_HEADER%|%PROJECT_HEADER%|%LINE_NUMBER_HEADER%
    Gui, todoGui: Add, Button, vAdd gAdd Default Section, %ADD_BUTTON_TEXT%
    Gui, todoGui: Add, Button, gArchive ys, %ARCHIVE_BUTTON_TEXT%
...
ShowTodo(){
    Gosub ShowTodoWindow
    Gui, todoGui: Show,AutoSize, TODOs
